...
const PAIRS = [
  ...
  ['prime-700', 'white', 4.5, 'orange link/text on white'],
  ...
  ['white', 'azure-700', 4.5, 'tech button label on blue'],
  ['ink-950', 'azure-400', 4.5, 'tech button label on blue, dark tone'],

  ['azure-700', 'white', 4.5, 'blue link on white'],
  ['azure-600', 'white', 4.5, 'blue link/icon on white'],
  ['azure-700', 'ink-50', 4.5, 'blue link on tinted'],
  ['azure-600', 'azure-50', 4.5, 'blue icon in blue chip'],
  ['azure-500', 'white', 3.0, 'focus ring on white'],
  ['azure-400', 'ink-950', 4.5, 'blue text on dark'],
  ['azure-300', 'ink-950', 4.5, 'blue lead text on dark'],
  ['azure-400', 'ink-900', 3.0, 'blue UI on dark panel'],
